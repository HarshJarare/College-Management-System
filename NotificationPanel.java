...
import jimsms.admin.AdminData;
import jimsms.faculty.Faculty;
import jimsms.faculty.FacultyData;
import jimsms.faculty.FacultyMain;
import jimsms.faculty.ViewFacultyPanel;
import jimsms.student.AttendanceReportPanel;
import jimsms.student.MarkSheetPanel;
import jimsms.student.Student;
import jimsms.student.StudentData;
import jimsms.student.StudentMain;
						...
						if(e.getButton()==MouseEvent.BUTTON1&&e.getClickCount()>0)
						{
							...
							else if(title.equals("Attendance"))
							{
								if(sm!=null)
								{
									...
									sm.attendancereportpanelscroll=new JScrollPane(sm.attendancereportpanel,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
